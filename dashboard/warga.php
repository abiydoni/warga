  ...
  <div class="main-content min-h-screen p-6">
    ...
    function loadProvinsi() {
      return new Promise((resolve, reject) => {
        ...
        $.get('dashboard/api/wilayah', { action: 'provinsi' }, function(data) {
    ...
    function loadKota(provinsi_id) {
      return new Promise((resolve, reject) => {
        ...
        $.get('dashboard/api/wilayah', { action: 'kota', provinsi_id: provinsi_id }, function(data) {
    ...
    function loadKecamatan(kota_id) {
      return new Promise((resolve, reject) => {
        ...
        $.get('dashboard/api/wilayah', { action: 'kecamatan', kota_id: kota_id }, function(data) {
    ...
    function loadKelurahan(kecamatan_id) {
      return new Promise((resolve, reject) => {
        ...
        $.get('dashboard/api/wilayah', { action: 'kelurahan', kecamatan_id: kecamatan_id }, function(data) {
